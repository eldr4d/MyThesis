...
\]
\[
T' = \left(A_\text{Base}^0\right)^{-1}T\left(A_4^\text{End}\right)^{-1}\left(R_z(\tfrac{\pi}{2})\right)^{-1}
\]
Then we invert $T'$:
\[
T'' = \left(T'\right)^{-1}
...
\begin{align*}
T' &= \left(A_\text{Base}^0\right)^{-1}T\left(A_4^\text{End}\right)^{-1}\\
T'' &= \left(T'\right)^{-1}\left(R_z(\tfrac{\pi}{2})\right)^{-1}\\
\theta_3 &= \left\{
	\begin{array}{l}
	arcsin\left(\frac{T''_{(3,4)}}{l_1}\right)\\
	\pi-arcsin\left(\frac{T''_{(3,4)}}{l_1}\right)
