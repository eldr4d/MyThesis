...
0 & 0 & 0 & 1
\end{bmatrix}\\
r_{11} &= \sin\theta_4\left(\sin\theta_1\sin\widehat{\theta}_3 - \cos\theta_1\cos\widehat{\theta}_2\cos\widehat{\theta}_3\right) - \cos\theta_1\cos\theta_4\sin\widehat{\theta}_2\\
r_{12} &= \cos\theta_4\left(\sin\theta_1\sin\widehat{\theta}_3 - \cos\theta_1\cos\widehat{\theta}_2\cos\widehat{\theta}_3\right) + \cos\theta_1\sin\widehat{\theta}_2\sin\theta_4\\
r_{13} &= \cos\widehat{\theta}_3\sin\theta_1 + \cos\theta_1\cos\widehat{\theta}_2\sin\widehat{\theta}_3\\
r_{14} &= l_4\left(\sin\theta_4\left(\sin\theta_1\sin\widehat{\theta}_3 - \cos\theta_1\cos\widehat{\theta}_2\cos\widehat{\theta}_3\right) - \cos\theta_1\cos\theta_4\sin\widehat{\theta}_2\right) - l_3\cos\theta_1\sin\widehat{\theta}_2\\
r_{21} &= \cos\widehat{\theta}_2\cos\theta_4 - \cos\widehat{\theta}_3\sin\widehat{\theta}_2\sin\theta_4\\
r_{22} &= \cos\widehat{\theta}_2\sin\theta_4 - \cos\widehat{\theta}_3\cos\theta_4\sin\widehat{\theta}_2\\
r_{23} &= \sin\widehat{\theta}_2\sin\widehat{\theta}_3\\
r_{24} &= l_1 + l_3\cos\widehat{\theta}_2 + l_4\left(\cos\widehat{\theta}_2\cos\theta_4 - \cos\widehat{\theta}_3\sin\widehat{\theta}_2\sin\theta_4\right)\\
r_{31} &= \sin\theta_4\left(\cos\theta_1\sin\widehat{\theta}_3 + \cos\widehat{\theta}_2\cos\widehat{\theta}_3\sin\theta_1\right) + \cos\theta_4\sin\theta_1\sin\widehat{\theta}_2\\
r_{32} &= \cos\theta_4\left(\cos\theta_1\sin\widehat{\theta}_3 + \cos\widehat{\theta}_2\cos\widehat{\theta}_3\sin\theta_1\right) - \sin\theta_1\sin\widehat{\theta}_2\sin\theta_4\\
r_{33} &= \cos\theta_1\cos\widehat{\theta}_3 - \cos\widehat{\theta}_2\sin\theta_1\sin\widehat{\theta}_3\\
r_{34} &= l_2 + l_4\left(\sin\theta_4\left(\cos\theta_1\sin\widehat{\theta}_3 + \cos\widehat{\theta}_2\cos\widehat{\theta}_3\sin\theta_1\right) + \cos\theta_4\sin\theta_1\sin\widehat{\theta}_2\right) + l_3\sin\theta_1\sin\widehat{\theta}_2
\end{align*}
where $\widehat{\theta}_2$ is the DH parameter $\theta$ for the second (LShoulderRoll) joint, $l_2 =$ ShoulderOffsetZ, $l_1 =$ ShoulderOffsetY $+$ ElbowOffsetY, $l_3 =$ UpperArmLength, and $l_4 =$ HandOffsetX~$+$~LowerArmLength.
...
\begin{align*}
T_{(2,2)} &= -\cos\widehat{\theta}_2\sin\theta_4 - \cos\widehat{\theta}_3\cos\theta_4\sin\widehat{\theta}_2 &\Leftrightarrow\\
\cos\widehat{\theta}_3\sin\widehat{\theta}_2 &= -\cfrac{\cos\widehat{\theta}_2\sin\theta_4 + T_{(2,2)}}{\cos\theta_4}
\end{align*}
...
\begin{align*}
&T_{(2,4)} = p_y = l_1 + l_3\cos\widehat{\theta}_2 + l_4\left(\cos\widehat{\theta}_2\cos\theta_4 - \cos\widehat{\theta}_3\sin\widehat{\theta}_2\sin\theta_4\right)&\Leftrightarrow\\
...
\begin{align*}
T_{(2,3)} &= \sin\left(\theta_2 - \frac{\pi}{2}\right)\sin\widehat{\theta}_3 &\Leftrightarrow \\
 \widehat{\theta}_3 &= \arcsin\left( \cfrac{ T_{(2,3)} }{ \sin\left(\theta_2-\frac{\pi}{2}\right)}\right)  &\text{because }    \theta_2 \neq \left|\frac{\pi}{2}\right|\\
 \theta_3 &= -\widehat{\theta}_3
\end{align*}
...
\cos\theta_1 &= \cfrac{T_{(1,3)}}{\cos\left(\theta_2 - \frac{\pi}{2}\right)\sin(-\theta_3)}  &\text{when } \theta_3 = \left|\frac{\pi}{2}\right|\text{ and } \theta_2 \neq0\\
\widehat{T} &=T\left({A^{\text{End}}_4}\right)^{-1}&\\
\cos\theta_1 &= \frac{\widehat{T}_{(1,4)}}{l_3}&\text{when } \theta_3 = \left|\frac{\pi}{2}\right|\text{ and } \theta_2 = 0
\end{align*}
There are trhee possible solutions for $\theta_1$ depending on the value of $\theta_3$ and $\theta_2$. So, when $\theta_3 = \left|\frac{\pi}{2}\right|$ and $\theta_2 \neq 0$:
\begin{align*}
&\theta_1 = \pm\arccos\left(\cfrac{T_{(1,3)}}{\cos\left(\theta_2 - \frac{\pi}{2}\right)\sin(-\theta_3)}\right)
\end{align*}
When, $\theta_3 = \left|\frac{\pi}{2}\right|$ and $\theta_2 = 0$:
\begin{align*}
\widehat{T} &=T\left({A^{\text{End}}_4}\right)^{-1}\\
\theta_1 &= \pm\arccos\left(\frac{\widehat{T}_{(1,4)}}{l_3}\right)
\end{align*}
...
\theta_3 &= -\left(\pi - \arcsin\left(\frac{T_{(2,3)}}{\sin\left(\theta_2-\frac{\pi}{2}\right)}\right)\right)\\
...
\theta_1 &= \pm\arccos\left(\cfrac{T_{(1,3)}}{\cos\left(\theta_2 - \frac{\pi}{2}\right)\sin(-\theta_3)}\right) \hspace*{4.9cm}\text{if } \theta_3 = \left|\frac{\pi}{2}\right| \text{ and } \theta_2 \neq 0\\
\widehat{T} &=T\left({A^{\text{End}}_4}\right)^{-1}&\\
\theta_1 &= \pm\arccos\left(\frac{\widehat{T}_{(1,4)}}{l_3}\right)\hspace*{7.8cm}\text{if } \theta_3 = \left|\frac{\pi}{2}\right|\text{ and } \theta_2 = 0
\end{align*}
...
\theta_1 &= \pm\arccos\left(\cfrac{T'_{(3,3)} + \cfrac{T'_{(1,3)}\sin\theta_3\cos\left(\theta_2 + \frac{\pi}{2}\right)}{\cos\theta_3}}{\cos\theta_3 + \cfrac{\cos^2\left(\theta_2 + \frac{\pi}{2}\right)\sin^2\theta_3}{\cos\theta_3}}\right) \hspace*{3cm}\text{if } \theta_3 \neq \cfrac{\pi}{2}& \\
\theta_1 &= \pm\arccos\left(\cfrac{T'_{(1,3)}}{\cos\left(\theta_2 +\frac{\pi}{2}\right)\sin\theta_3}\right) \hspace*{5.5cm}\text{if } \theta_3 = \left|\frac{\pi}{2}\right| \text{ and } \theta_2 \neq 0\\
\widehat{T} &=T'\left({A^{\text{End}}_4}\right)^{-1}&\\
\theta_1 &= \pm\arccos\left(\frac{\widehat{T}_{(1,4)}}{l_3}\right)\hspace*{7.8cm}\text{if } \theta_3 = \left|\frac{\pi}{2}\right|\text{ and } \theta_2 = 0
\end{align*}
